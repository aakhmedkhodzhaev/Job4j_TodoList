            ...
            <form action="<%=request.getContextPath()%>/auth.do" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" id="pwd" name="pwd" title="Enter password"
                               placeholder="Enter Email">
                    </div>
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-success" onclick="validate()" style="border-radius:5px;">Войти</button>
                    <button type="reset" class="btn btn-danger" onclick="validate()" style="border-radius:5px;">Очистить</button>
                    <a href="#" style="color: white; font-size: 15px; float: right; margin-right: 10px;"> Восстановления пароля </a>
                    <a href="#" style="color: white; font-size: 15px; float: right; margin-right: 10px;"> Регистрация </a>
                </div>
                <br/><br/>
            </form>
        </div>
